---
description: Use when the agent need to understand how to use Vitest, to create automatic tests, or to understand test files, or any issue with Vitest.
...
- [tags | Config](/config/tags.md)
- [strictTags | Config](/config/stricttags.md)
...
- [browser.detailsPanelPosition | Config](/config/browser/detailspanelposition.md)
...
- [Test Tags | Guide](/guide/test-tags.md)
...
- [vitest-browser-react](/api/browser/react.md)
- [vitest-browser-vue](/api/browser/vue.md)
- [vitest-browser-svelte](/api/browser/svelte.md)
...
- [detectAsyncLeaks | Config](/config/detectasyncleaks.md)
